...
{
    /// <summary>
    /// Interface for Channels operations
    /// </summary>
    public interface IChannelsActions
    {
        /// <summary>
        /// Asynchronously list all active channels in asterisk.. 
        /// </summary>
        Task<List<Channel>> ListAsync();

        /// <summary>
        /// Asynchronously create a new channel (originate).. the new channel is created immediately and a snapshot of it returned. if a stasis application is provided it will be automatically subscribed to the originated channel for further events and updates.
        /// </summary>
        ...
        /// <summary>
        /// Asynchronously channel details.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task<Channel> GetAsync(string channelId);

        /// <summary>
        /// Asynchronously create a new channel (originate with id).. the new channel is created immediately and a snapshot of it returned. if a stasis application is provided it will be automatically subscribed to the originated channel for further events and updates.
        /// </summary>
        /// <param name="channelId">The unique id to assign the channel on creation.</param>
        /// <param name="endpoint">Endpoint to call.</param>
        /// <param name="extension">The extension to dial after the endpoint answers. Mutually exclusive with 'app'.</param>
        ...
        /// <summary>
        /// Asynchronously delete (i.e. hangup) a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously exit application; continue execution in the dialplan.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        Task ContinueInDialplanAsync(string channelId, string? context = null, string? extension = null, int priority = 0, string? label = null);

        /// <summary>
        /// Asynchronously move the channel from one stasis application to another.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously redirect the channel to a different location.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously answer a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task AnswerAsync(string channelId);

        /// <summary>
        /// Asynchronously indicate ringing to a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task RingAsync(string channelId);

        /// <summary>
        /// Asynchronously stop ringing indication on a channel if locally generated.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task RingStopAsync(string channelId);

        /// <summary>
        /// Asynchronously send provided dtmf to a given channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        Task SendDTMFAsync(string channelId, string? dtmf = null, int before = 0, int between = 100, int duration = 100, int after = 0);

        /// <summary>
        /// Asynchronously mute a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously unmute a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously hold a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task HoldAsync(string channelId);

        /// <summary>
        /// Asynchronously remove a channel from hold.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task UnholdAsync(string channelId);

        /// <summary>
        /// Asynchronously play music on hold to a channel.. using media operations such as /play on a channel playing moh in this manner will suspend moh without resuming automatically. if continuing music on hold is desired, the stasis application must reinitiate music on hold.
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously stop playing music on hold to a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task StopMohAsync(string channelId);

        /// <summary>
        /// Asynchronously play silence to a channel.. using media operations such as /play on a channel playing silence in this manner will suspend silence without resuming automatically.
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task StartSilenceAsync(string channelId);

        /// <summary>
        /// Asynchronously stop playing silence to a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task StopSilenceAsync(string channelId);

        /// <summary>
        /// Asynchronously start playback of media.. the media uri may be any of a number of uri's. currently sound:, recording:, number:, digits:, characters:, and tone: uri's are supported. this operation creates a playback resource that can be used to control the playback of media (pause, rewind, fast forward, etc.)
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <param name="offsetms">Number of milliseconds to skip before playing. Only applies to the first URI if multiple media URIs are specified.</param>
        /// <param name="skipms">Number of milliseconds to skip for forward/reverse operations.</param>
        Task<Playback> PlayWithIdAsync(string channelId, string playbackId, string media, string? lang = null, int offsetms = 0, int skipms = 3000);

        /// <summary>
        /// Asynchronously start a recording.. record audio from a channel. note that this will not capture audio sent to the channel. the bridge itself has a record feature if that's what you want.
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        Task<LiveRecording> RecordAsync(string channelId, string name, string format, int maxDurationSeconds = 0, int maxSilenceSeconds = 0, string? ifExists = null, bool beep = false, string? terminateOn = null);

        /// <summary>
        /// Asynchronously get the value of a channel variable or function.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously set the value of a channel variable or function.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously start snooping.. snoop (spy/whisper) on a specific channel.
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        ...
        /// <summary>
        /// Asynchronously dial a created channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        /// <param name="caller">Channel ID of caller</param>
        /// <param name="timeout">Dial timeout</param>
        Task DialAsync(string channelId, string? caller = null, int timeout = 0);

        /// <summary>
        /// Asynchronously rtp stats on a channel.. 
        /// </summary>
        /// <param name="channelId">Channel's id</param>
        Task<RTPstat> RtpstatisticsAsync(string channelId);

        /// <summary>
        /// Asynchronously start an external media session.. create a channel to an external media source/sink.
        /// </summary>
        /// <param name="channelId">The unique id to assign the channel on creation.</param>
        /// <param name="app">Stasis Application to place channel into</param>
        /// <param name="variables">The "variables" key in the body object holds variable key/value pairs to set on the channel on creation. Other keys in the body object are interpreted as query parameters. Ex. { "endpoint": "SIP/Alice", "variables": { "CALLERID(name)": "Alice" } }</param>
